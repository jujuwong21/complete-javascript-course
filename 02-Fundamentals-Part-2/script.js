...
const yearsTilRetire = [yearsUntilRetirement2(birthYears[0]),
yearsUntilRetirement2(birthYears[1]), yearsUntilRetirement2(birthYears[2]), yearsUntilRetirement2(birthYears[3]), yearsUntilRetirement2(birthYears[4]), yearsUntilRetirement2(birthYears[5])];
...
console.log(julietteObj.lastName, julietteObj["lastName"], julietteObj["last" + "Name"]);
const interestedIn = prompt("Type firstName, lastName, birthYear, job, or friends");
...
console.log(`${julietteObj.firstName} has ${julietteObj.friends.length} friends, and her best friend is ${julietteObj.friends[0]}`);
...
julietteObj.calcAge = function () { // this keyword method
    return 2021 - this.birthYear;
}
console.log("With this keyword:", julietteObj.calcAge());
delete julietteObj.calcAge;
julietteObj.calcAge = function () { // create a new property (age)
